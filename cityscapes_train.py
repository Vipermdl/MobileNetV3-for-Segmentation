...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default = "MobileNet", help = "model name: Context Guided Network (MobileNet)")
    parser.add_argument('--dataset', default = "cityscapes", help = "dataset: cityscapes or camvid")
    parser.add_argument('--data_dir', default = "/home/madongliang/dataset/cityscapes/cityscape", help ='data directory')
    ...
    parser.add_argument('--resume', type = str, default = "./checkpoint/cityscapes/MobileNetV3bs16gpu2_ontrainval/model_1.pth",
    ...
    parser.add_argument('--gpus', type = str, default = "2,3", help = "default GPU devices (0,1)")
